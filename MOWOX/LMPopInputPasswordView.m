...
-(void)customInit
{
    ...
    _titleLabel.text = LocalString(@"Please input PIN code");
    ...
    [_cancelButton setTitle:LocalString(@"Cancel") forState:UIControlStateHighlighted];
    _cancelButton.tag = 0;
    ...
    [_ensureButton setTitle:LocalString(@"Done") forState:UIControlStateNormal];
    [_ensureButton setTitle:LocalString(@"Done") forState:UIControlStateHighlighted];
    _ensureButton.tag = 1;
